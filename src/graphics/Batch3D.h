...
class Batch3D {
	...
	void vertex(glm::vec3 point, glm::vec2 uvpoint, float r, float g, float b, float a);
...
public:
	...
	void sprite(glm::vec3 pos, glm::vec3 up, glm::vec3 right, float w, float h, int atlasRes, int index, glm::vec4 tint);
