...
class Batch2D {
	...
	void vertex(glm::vec2 point, glm::vec2 uvpoint, float r, float g, float b, float a);
...
public:
	...
	void blockSprite(float x, float y, float w, float h, int atlasRes, int index[6], glm::vec4 tint);

    void point(float x, float y, float r, float g, float b, float a);
	void line(float x1, float y1, float x2, float y2, float r, float g, float b, float a);

	void rect(float x, float y, float w, float h, float ox, float oy, float angle, UVRegion region, bool flippedX, bool flippedY, glm::vec4 tint);
