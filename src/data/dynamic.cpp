...
Map& Map::put(std::string key, int64_t value) {
    ...
    valvalue val;
    val.integer = value;
    values.insert(std::make_pair(key, new Value(ValueType::integer, val)));
    return *this;
}
...
Map& Map::put(std::string key, double value) {
    valvalue val;
    val.decimal = value;
    values.insert(std::make_pair(key, new Value(ValueType::number, val)));
    return *this;
}
...
Map& Map::put(std::string key, std::string value){
    valvalue val;
    val.str = new std::string(value);
    values.insert(std::make_pair(key, new Value(ValueType::string, val)));
    return *this;
}
...
Map& Map::put(std::string key, Map* value){
    valvalue val;
    val.map = value;
    values.insert(std::make_pair(key, new Value(ValueType::map, val)));
    return *this;
}
...
Map& Map::put(std::string key, List* value){
    valvalue val;
    val.list = value;
    values.insert(std::make_pair(key, new Value(ValueType::list, val)));
    return *this;
}
...
Map& Map::put(std::string key, bool value){
    valvalue val;
    val.boolean = value;
    values.insert(std::make_pair(key, new Value(ValueType::boolean, val)));
    return *this;
}
