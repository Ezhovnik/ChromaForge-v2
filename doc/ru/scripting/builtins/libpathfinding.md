...
При использовании в логике сущностей следует использовать компонент `builtin:pathfinding`.

## Компонент `builtin:pathfinding`

```lua
local pf = entity:get_component("builtin:pathfinding")
