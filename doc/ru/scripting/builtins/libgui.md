...
- [Библиотека *gui*](#библиотека-gui)
  ...
  - [Диалоговые страницы меню (устаревший подход)](#диалоговые-страницы-меню-устаревший-подход)
...
gui.load_document(
    path: string,  -- путь к xml файлу, например: builtin:layouts/pages/main.xml
    name: string,  -- id документа, например: builtin:pages/main
