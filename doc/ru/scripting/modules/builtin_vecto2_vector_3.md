# Модули builtin:vector2, builtin:vector3

## Vector2

### Операции над векторами с двумя элементами
...
### Операции с векторами с двумя элементами

```lua
    local vec2 = require("builtin:vector2")
...
### Операции над векторами с тремя элементами
...
### Операции с векторами с тремя элементами

```lua
    
local vec3 = require("builtin:vector3")
