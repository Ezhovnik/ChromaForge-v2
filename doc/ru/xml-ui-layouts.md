...
- `onmouseenter` - lua функция вызываемая при входе курсора в элемент (не учитывает иерархию элементов).
- `onmouseleave` - lua функция вызываемая при выходе курсора из элемента (не учитывает иерархию элементов).
