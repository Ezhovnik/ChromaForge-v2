...
function run_current_file()
    ...
    local func = function()
        ...
        xpcall(chunk, function(msg) __chroma__error(msg, 1, 1, stack_size) end)
    end
    ...
    local output = builtin.capture_output(function() func(unit) end)
    document.output:paste(string.format("\n%s", output))
end
