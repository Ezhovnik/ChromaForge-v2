...
local LoggerClass = {
    __index = {
        trace = function (self, text)
            debug.trace(string.format("[%s] %s", slef.name, text))
        end,
        info = function (self, text)
            debug.info(string.format("[%s] %s", self.name, text))
        end,
        ...
        critical = function (self, text)
            debug.critical(string.format("[%s] %s", self.name, text))
        end,
    }
}
